...
const encodeDirect = (verts: number[], tris: RawFace[], quads: RawFace[]): Primitive => {
...
const replaceModel = (
    ...
    for (let i = 0; i < 3; i++) {
        ...
        console.log("%s %s %s", triCount.toString(16), quadCount.toString(16), vertCount.toString(16))
