...
test("it should export an obj of the homing missile", () => {
  const filename = "PL00R05";
  const file = readFileSync(`./bin/wpn_${filename}.BIN`).subarray(0x800);
